                    ...
                    <table class="border-collapse table-auto w-full text-sm">
                        <thead>
                            <tr>
                                ...
                                <th width='20%' class="border dark:border-slate-600 font-medium p-4 pl-8 pt-3 pb-3 text-slate-400 dark:text-slate-200 text-left">Brand</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border border-slate-200 dark:border-slate-600 p-4 pl-8 text-slate-500 dark:text-slate-400">{{$item->brand}}</td>
